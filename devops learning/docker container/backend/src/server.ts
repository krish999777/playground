...
//docker run command docker run -p 8000:8000  --rm  -e PORT=8000 -e DATABASE_URL=db_url  -e JWT_SECRET=jwt_secret -e CLOUD_NAME=cloud_name -e API_KEY=api_key -e API_SECRET=api_secret -e FRONTEND_URL=frontend_url [container_id]
